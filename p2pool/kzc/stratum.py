...
from p2pool.kzc import data as kzc_data, getwork
...
class StratumRPCMiningProvider(object):
    ...
    def _send_work(self):
        ...
        self.other.svc_mining.rpc_set_difficulty(kzc_data.target_to_difficulty(x['share_target'])).addErrback(lambda err: None)
    ...
    def rpc_submit(self, worker_name, job_id, extranonce2, ntime, nonce, *args):
        ...
        header = dict(
            ...
            merkle_root=kzc_data.check_merkle_link(kzc_data.hash256(new_packed_gentx), x['merkle_link']),
