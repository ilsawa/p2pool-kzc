    ...
    def test_sharereq(self):
        class MyNode(p2p.Node):
            def __init__(self, df):
                p2p.Node.__init__(self, lambda: None, 28999, networks.nets['kzc'], {}, set([('127.0.0.1', 8999)]), 0, 0, 0, 0)
        ...
        class MyNode(p2p.Node):
            ...
            def got_conn(self, conn):
                ...
                for i in xrange(3):
                    ...
                    new_mining_txs[kzc_data.hash256(kzc_data.tx_type.pack(huge_tx))] = huge_tx
