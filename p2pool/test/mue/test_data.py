...
from p2pool.kzc import data, networks
...
class Test(unittest.TestCase):
    ...
    def test_header_hash_kzc(self):
        assert networks.nets['kzc'].POW_FUNC(data.block_header_type.pack(dict(
            version=3,
    ...
    def test_address_to_pubkey_hash(self):
        assert data.address_to_pubkey_hash('7gnwGHt17heGpG9Crfeh4KGpYNFugPhJdh', networks.nets['kzc']) == pack.IntType(160).unpack('9dc8b19033a16913b6e45437f76d0ab649e9e516'.decode('hex'))
