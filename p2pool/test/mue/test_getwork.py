...
from p2pool.kzc import getwork, data as kzc_data
    ...
    def test_all(self):
        ...
        case2s = [
            getwork.BlockAttempt(
                ...
                1305759879,
                kzc_data.FloatingInteger.from_target_upper_bound(0x44b9f20000000000000000000000000000000000000000000000),
